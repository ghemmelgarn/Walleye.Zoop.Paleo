...
#1.5) biomass no transformation - WITH EUCLIDEAN DISTANCE
...
transformation = "no_transformation"
      ...
      spp_30 <- NMDS_30[,4:28]
      #make the NMDS files
      bray_dist_13 <- metaMDS(spp_13, distance = "euclidean", trymax = 1000)
      bray_dist_13_corr <- metaMDS(spp_13_corr, distance = "euclidean", trymax = 1000)
      bray_dist_30 <- metaMDS(spp_30, distance = "euclidean", trymax = 1000)
      #extract axis scores for the sites (samples) only
      scores_13 <- as.data.frame(scores(bray_dist_13, display = "sites")) %>% 
        mutate(net_size = "13",
               lake_name = NMDS_13$lake_name,
      ...
      plot_current <- ggplot(data = plot_scores, aes(x = NMDS1, y = NMDS2, color = lake_name, alpha = net_size, shape = month)) +
        geom_point(size = 3)+
        labs(title = paste(datatype, transformation, "NMDS Euclidean Distance"), y = "NMDS2", x = "NMDS1") +
        scale_alpha_manual(values = c("30" = 1.0, "13" = 0.6, "13_corrected" = 0.3))+
        theme_classic()
      plot_current
      ggsave(filename = paste(datatype, transformation, "NMDS_euclidean.png", sep = "_"), plot = plot_current, width = 10, height = 8, units = "in", dpi = 300)
      ...
      plot_current_panels <- ggplot(data = plot_scores, aes(x = NMDS1, y = NMDS2, shape = net_size, color = month)) +
        ...
        theme_classic()
      plot_current_panels
      ggsave(filename = paste(datatype, transformation, "by_lake_NMDS_euclidean.png", sep = "_"), plot = plot_current_panels, width = 10, height = 9, units = "in", dpi = 300)
      ...
      plot_current_stJames <- ggplot(data = plot_scores_stJames, aes(x = NMDS1, y = NMDS2, shape = net_size, color = month)) +
        geom_point(size = 3, alpha = 0.6)+
        labs(title = paste("St. James", datatype, transformation, "NMDS Euclidean Distance"), y = "NMDS2", x = "NMDS1") +
        scale_alpha_manual(values = c("30" = 1.0, "13" = 0.6, "13_corrected" = 0.3))+
        theme_classic()
      ggsave(filename = paste("StJames", datatype, transformation, "NMDS_euclidean.png", sep = "_"), plot = plot_current_stJames, width = 8, height = 6, units = "in", dpi = 300)
      plot_current_Greenwood <- ggplot(data = plot_scores_Greenwood, aes(x = NMDS1, y = NMDS2, shape = net_size, color = month)) +
        geom_point(size = 3, alpha = 0.6)+
        labs(title = paste("Greenwood", datatype, transformation, "NMDS Euclidean Distance"), y = "NMDS2", x = "NMDS1") +
        scale_alpha_manual(values = c("30" = 1.0, "13" = 0.6, "13_corrected" = 0.3))+
        theme_classic()
      ggsave(filename = paste("Greenwood", datatype, transformation, "NMDS_euclidean.png", sep = "_"), plot = plot_current_Greenwood, width = 8, height = 6, units = "in", dpi = 300)
      plot_current_Shaokotan <- ggplot(data = plot_scores_Shaokotan, aes(x = NMDS1, y = NMDS2, shape = net_size, color = month)) +
        geom_point(size = 3, alpha = 0.6)+
        labs(title = paste("Shaokotan", datatype, transformation, "NMDS Euclidean Distance"), y = "NMDS2", x = "NMDS1") +
        scale_alpha_manual(values = c("30" = 1.0, "13" = 0.6, "13_corrected" = 0.3))+
        theme_classic()
      ggsave(filename = paste("Shaokotan", datatype, transformation, "NMDS_euclidean.png", sep = "_"), plot = plot_current_Shaokotan, width = 8, height = 6, units = "in", dpi = 300)      
