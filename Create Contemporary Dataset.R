...
# #DECISION: anything that is not calculated ONLY with a June sample
...
# 
# 
# #I ORIGINALLY WANTED THE REPORTED SUMMER AVERAGE (June-Sept), BUT THE OLDER DATA ONLY HAS LATE SUMMER AVERAGE (July-Sept)
